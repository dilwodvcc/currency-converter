        ...
        <form action="index.php" method="POST">
            <div class="row g-3 align-items-center">
                <div class="col-md-5">
                    ...
                    <input type="number" id="qiymat" name="qiymat" class="form-control" placeholder="Amount" value="" >
                </div>
                ...
                <div class="col-md-3">
                    <select class="form-select" name="froms">
                    <?php 
                        global $currencies;
                        $i = 0;
                        foreach ($currencies as $key => $currency) {
            ...
            <?php 
                if ($result) {
                    echo '<p class="mt-3">Natija: ' . $result . '</p>';
                }
            ?>
